...
const updateScoreBoard = () => {
    ...
    p1s.ariaLabel = `Player has ${Game.getP1Session()} wins this session`;
...
const finsishGameFlow = (playerChoice) => {
...
const getAction = (choice) => {
    return choice === "rock" ? "smashes" : choice === "paper" ?
    "wraps" : "cuts";
}
...
const updatePesistentData = (winner) => {
